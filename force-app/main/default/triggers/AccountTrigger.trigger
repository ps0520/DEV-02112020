...
********************************************************/    
    if(trigger.isBefore){
        if(trigger.isInsert){             
            ...
            //Method to populate Top level Parent for an Account-IQVIA requirement-25-Aug-2020
            ClsAccountValRequestTriggerHandler.updateTopParentAccount(Trigger.new);//NS-743
        }
        if(trigger.isUpdate){       
